import{_ as a,r as c,o as r,c as o,a as e,b as t,d as l,e as s}from"./app-546c4c18.js";const p={},i={class:"custom-container tip"},d=e("p",{class:"custom-container-title"},"TIP",-1),g={href:"https://godotengine.org",target:"_blank",rel:"noopener noreferrer"},m=e("p",null,"希望能够帮助更多小伙伴开启独立游戏制作的大门。",-1);function x(y,_){const n=c("ExternalLinkIcon");return r(),o("div",null,[e("div",i,[d,e("p",null,[t("本站的目的是为了介绍如何使用 "),e("a",g,[t("Godot 引擎"),l(n)]),t(" 进行游戏开发的。")]),m]),s(` <h2 style="text-align: center;">基于 Godot 的 2D 游戏上手指南地图 <Badge text="探索中……"  /></h2>
...
<\/script> `)])}const u=a(p,[["render",x],["__file","index.html.vue"]]);export{u as default};
